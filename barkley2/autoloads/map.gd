...
const MAP_AREA_LIST = preload("res://barkley2/resources/B2_Map/map_area_list.json")
const MAP_ICON_LIST = preload("res://barkley2/resources/B2_Map/map_icon_list.json")
...
## 11/10/25 disabled most of this. JSON files created to handle this bullshit.
#region Legacy stuff
#
#func _init() -> void:
	#init_setup()
...
#
	...
	### Districts ##
	#add_icon("Tír na nÓg", "sMapIconHoopz", 197, 92, ["room", "==", "r_tnn_residentialDistrict01"], ["x", "<", "588"], ["y", "<", "488"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 230, 152, ["room", "==", "r_tnn_residentialDistrict01"], ["x", ">=", "588"], ["y", ">=", "488"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 231, 95, ["room", "==", "r_tnn_residentialDistrict01"], ["x", ">=", "588"], ["y", "<", "488"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 191, 145, ["room", "==", "r_tnn_residentialDistrict01"], ["x", "<", "588"], ["y", ">=", "488"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 49, 117, "room", "==", "r_tnn_warehouseDistrict01", ["y", "<", "424"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 52, 147, "room", "==", "r_tnn_warehouseDistrict01", ["y", ">=", "424"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 27, 70, "room", "==", "r_tnn_businessDistrict01", ["x", "<", "856"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 73, 73, "room", "==", "r_tnn_businessDistrict01", ["x", ">=", "856"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 145, 33, ["room", "==", "r_tnn_marketDistrict01"], ["x", "<", "936"], ["y", "<", "560"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 187, 37, ["room", "==", "r_tnn_marketDistrict01"], ["x", ">=", "936"], ["y", "<", "560"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 151, 70, ["room", "==", "r_tnn_marketDistrict01"], ["x", "<", "936"], ["y", ">=", "560"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 214, 67, ["room", "==", "r_tnn_marketDistrict01"], ["x", ">=", "936"], ["y", ">=", "560"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 117, 116, ["room", "==", "r_tnn_maingate02"], ["y", "<", "130"]);
	#add_icon("Tír na nÓg", "sMapIconHoopz", 125, 164, ["room", "==", "r_tnn_maingate02"], ["y", ">=", "130"]);
...
#
	...
	### Kelpster ##
	#add_icon("Tír na nÓg", "sMapIconGrapes",    47,  71,  ["kelpsterState", "==", "2"], ["fruitbasketTake", "!=", "2"]);
	#
	### Wilmer Quest ##
	#add_icon("Tír na nÓg", "sMapIconRent", 46, 101, ["wilmerEvict", "==", "1"], ["mortgageDoorRealize", "==", "0"]);
	#
	###Demo Helper
	#add_icon("Tír na nÓg", "sMapIconSewers", 204, 17, ["knowLONGINUSTnn", ">=", "1"]);
	#add_icon("Tír na nÓg", "sMapIconTutorial", 208, 93, [] );
	#
	###Lugner Quest
	#add_icon("Tír na nÓg", "sMapIconHelper", 219, 49, ["lugnerQuest", "==", "3"]);
	#add_icon("Tír na nÓg", "sMapIconHelper", 19, 139, ["lugnerQuest", ">=", "4"], ["lugnerQuest", "<=", "6"] );
	#
	###Main Quest
	#add_icon("Tír na nÓg", "sMapIconExit", 123, 144, ["operationX", "==", "2"]);
#
	#############################/
	### Sewers Floor 1
	#############################/
	...
	#add_icon("Sewers Floor 1", "sMapIconHoopz", 125, 160, ["room", "==", "r_sw1_longWays01"], ["x", ">=", "648"]); ##  - 
	#add_icon("Sewers Floor 1", "sMapIconHoopz", 86, 159, ["room", "==", "r_sw1_longWays01"], ["x", "<", "648"]); ##  - 
...
#
	...
	###add_icon("Sewers Floor 1", "sMapIconHoopz", 155, 58);##, "room", "==", "r_swr_room", "x", ">", "500");
	#add_icon("The Eastelands", "sMapIconHoopz", 161, 121, ["room", "==", "r_est_cgremArena01"], ["x", "<=", "415"]);
	#add_icon("The Eastelands", "sMapIconHoopz", 208, 121, ["room", "==", "r_est_cgremArena01"], ["x", ">=", "416"]);
	#add_icon("The Eastelands", "sMapIconHoopz", 155, 169, ["room", "==", "r_est_cgremPath01"], ["y", ">=", "560"]);
	#add_icon("The Eastelands", "sMapIconHoopz", 152, 143, ["room", "==", "r_est_cgremPath01"], ["y", "<=", "559"]);
	...
	#add_icon("The Eastelands", "sMapIconHoopz", 193, 80, ["room", "==", "r_est_easternPaths01"], ["y", "<=", "423"]);
	#add_icon("The Eastelands", "sMapIconHoopz", 193, 80, ["room", "==", "r_est_easternPaths01"], ["y", ">=", "424"], ["x", "<=", "367"]);
	#add_icon("The Eastelands", "sMapIconHoopz", 208, 92, ["room", "==", "r_est_easternPaths01"], ["y", ">=", "424"], ["x", ">=", "368"]);
	...
	#add_icon("The Eastelands", "sMapIconHoopz", 298, 39, ["room", "==", "r_est_mountainBase01"], ["y", "<=", "1208"]);
	#add_icon("The Eastelands", "sMapIconHoopz", 298, 70, ["room", "==", "r_est_mountainBase01"], ["y", ">=", "1208"]);
...
#
	...
	#
	## Make JSON files
	#var file_area = FileAccess.open( "res://barkley2/resources/B2_Map/map_area_list.json", FileAccess.WRITE )
	#var file_icon = FileAccess.open( "res://barkley2/resources/B2_Map/map_icon_list.json", FileAccess.WRITE )
	#file_area.store_string( JSON.stringify(map_directory, "\t") )
	#file_icon.store_string( JSON.stringify(icon_directory, "\t") )
...
## 11/10/25 Not ignoring anymore. Bugtesting the game without a map is hard.
#@warning_ignore("unused_variable")
#@warning_ignore("unused_parameter")
#func add_icon( area_name : String, map_sub : String, x : int, y : int, ...condition : Array) -> void: # <- Godot 4.5 function! I had no idea whot to make this work 
	#if not icon_directory.has( area_name ):
		#icon_directory[ area_name ] = []
	#
	#icon_directory[ area_name ].append( [map_sub, x, y, condition] )
#endregion

static func has_map_id( area_id : int ) -> bool:
	return MAP_AREA_LIST.data.has( str(area_id) )
	
static func has_map_name( area_name : String ) -> bool:
	return MAP_AREA_LIST.data.values().has( area_name )

static func get_map_name( area_id : int ) -> String:
	assert( MAP_AREA_LIST.data.has( str(area_id) ), "No area id %s. %s" % [area_id, MAP_AREA_LIST.data] )
	return MAP_AREA_LIST.data.get( str(area_id) )

static func get_map_icons( area_name : String ) -> Array:
	assert( MAP_ICON_LIST.data.has(area_name) )
	return MAP_ICON_LIST.data.get( area_name, [] )
