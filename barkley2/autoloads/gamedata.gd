...
#func _save_stuff_to_disk() -> void:
	...
	#
	#var file2 = FileAccess.open( "res://barkley2/resources/B2_Portrait/portrait_name_index.json", FileAccess.WRITE )
	#file2.store_string( JSON.stringify(portrait_from_name, "\t") )
