...
@export var o_cinema2 : B2_CinemaSpot
...
func _ready() -> void:
	...
	if B2_Playerdata.Quest("cgremQuest") >= 1:
		assert( o_cinema2 )
		global_position = o_cinema2.global_position

	ANIMATION_STAND 						= "s_cgrem_henchman02_stand"
	...
	ActorAnim.animation 					= "s_cgrem_henchman02_stand"
