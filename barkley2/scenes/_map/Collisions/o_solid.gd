@tool
@icon("res://barkley2/assets/b2_original/images/merged/s_solid16.png")
extends B2_RIGID_SOLID
class_name B2_SOLID
...
func _draw() -> void:
	if Engine.is_editor_hint():
		z_index = 4000
		draw_rect( Rect2( Vector2.ZERO, Vector2(width, height) ), Color(Color.GREEN,0.1), 		true ) 			## BG
		draw_rect( Rect2( Vector2.ZERO, Vector2(width, height) ), Color(Color.DARK_GREEN,0.6), 	false, 4.0 ) 	## Outline
